        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    ...
                    InlineKeyboardButton(
                        "Commands 🛠", url=f"https://telegra.ph/Music-Bot-05-07"),
                    InlineKeyboardButton(
                        "Credits ❤", url=f"https://telegra.ph/Group-Music-X-Bot-05-17")
                ]
            ]
        ),
...
@client.on_message(filters.incoming & filters.command(['ping]))
async def _(event):
    start = datetime.now()
    end = datetime.now()
